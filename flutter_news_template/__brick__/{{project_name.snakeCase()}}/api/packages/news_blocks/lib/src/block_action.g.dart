...
) => $checkedCreate('NavigateToArticleAction', json, ($checkedConvert) {
...
NavigateToFeedCategoryAction _$NavigateToFeedCategoryActionFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('NavigateToFeedCategoryAction', json, ($checkedConvert) {
...
NavigateToSlideshowAction _$NavigateToSlideshowActionFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('NavigateToSlideshowAction', json, ($checkedConvert) {
